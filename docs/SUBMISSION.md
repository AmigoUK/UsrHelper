...
| Promotional video | `https://youtu.be/UESEtxdViBM` — verified Public on 2026-07-22 (title "UsrHelper"), so the field will accept it. The store takes a YouTube URL and nothing else. |
